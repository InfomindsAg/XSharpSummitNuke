...
function Start() as void strict
   ...
   // BenchmarkRunner.Run(typeof(Config).Assembly, config) // Runs all the benchmarks in the assembly
   BenchmarkRunner.Run(typeof(AdHocBenchmarks), config) // Runs the AdHocBenchmarks benchmarks
   Console.ReadLine()
